...
public class CalculateAverage_seijikun {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        final int jobCnt = Runtime.getRuntime().availableProcessors();
...
//        System.out.println(STR."Took: \{endTs - startTs}ms");
...
//                    final var ctxStart = Math.max(0, i - 20);
//                    final var ctxEnd = Math.min(output.length() - 1, i + 20);
//                    final var ctxActual = output.substring(ctxStart, ctxEnd);
//                    final var ctxShould = SHOULD_OUTPUT.substring(ctxStart, ctxEnd);
