...
if [ ! -f target/CalculateAverage_artsiomkorzun_image ]; then
    NATIVE_IMAGE_OPTS="--gc=epsilon -O3 -march=native -dsa -R:MaxHeapSize=64m -H:-GenLoopSafepoints --enable-preview --initialize-at-build-time=dev.morling.onebrc.CalculateAverage_artsiomkorzun"
