...
=======
    target/CalculateAverage_karthikeyan97_image -Xms20480m -Xmx40960m
else
    JAVA_OPTS="--enable-preview"
    #echo "Chosing to run the app in JVM mode as no native image was found, use prepare_karthikeyan97.sh to generate." 1>&2
    java -Xms20480m -Xmx40960m --class-path target/average-1.0.0-SNAPSHOT.jar dev.morling.onebrc.CalculateAverage_karthikeyan97
>>>>>>> final comit
fi
