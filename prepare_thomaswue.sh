...
if [ ! -f target/CalculateAverage_thomaswue_image ]; then
    NATIVE_IMAGE_OPTS="-O3 -march=native --enable-preview -H:InlineAllBonus=10 -H:-ParseRuntimeOptions --initialize-at-build-time=dev.morling.onebrc.CalculateAverage_thomaswue\$Scanner"
