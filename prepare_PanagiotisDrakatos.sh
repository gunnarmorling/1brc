...
if [ ! -f target/CalculateAverage_PanagiotisDrakatos_image ]; then
    NATIVE_IMAGE_OPTS="--gc=epsilon -O3 -march=native -R:MaxHeapSize=64m --enable-preview --initialize-at-build-time=dev.morling.onebrc.CalculateAverage_PanagiotisDrakatos"
